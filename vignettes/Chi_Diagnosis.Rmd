...
本套件使用的診斷編碼依照 CMS （Centers for Medicare & Medicaid Services）所提供的診斷編碼做為標準依據，並依照WHO訂定的診斷編碼規則，分別產生 ICD-9-CM and ICD-10-CM 的兩種格式的表格: `ICD9DxwithTwoFormat` 和 `ICD10DxwithTwoFormat` 供後續診斷編碼格式轉換的功能使用 
