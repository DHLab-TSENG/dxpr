---
title: "Chinese Version-Diagnosis: Get Started"
...
將分散的 ICD-9-CM 及 ICD-10-CM 的診斷碼依照其臨床上意義相似的歸併整合為較大的群組, 標準化的分類以便於後續的整合統計分析使用
...
### 自定義診斷碼分組 (groupIcdDxToCustomGrep)

因應臨床研究需求, 使用者可自行定義診斷分組類別及類別項目
