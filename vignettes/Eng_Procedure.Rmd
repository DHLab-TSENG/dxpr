...
head(short$ICD)
```
**warning message** (More detail: [Get started with dxpr: Diagnosis](https://dhlab-tseng.github.io/dxpr/articles/Eng_Diagnosis.html#i--code-standardization))
...
The dxpr package supports two strategies to group EHR procedure codes, including CCS and procedure classes.  
