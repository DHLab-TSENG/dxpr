...
####單一階層分類 (CCS Category)
`IcdDxToCCS` 可取得 ICD-9-CM 及 ICD-10-CM 相對應的 CCS 分類及分類之敘述
...
`IcdDxToCCSLvl` 可取得 ICD-9-CM 及 ICD-10-CM 相對應的 CCS 多階層分類及分類之敘述
...
目前提供兩種方法:
 ...
 1) `IcdDxToCustomGrep`: 使用`窮舉法`的方式找出符合的ICD
```{r}
# groupingTable 
...
```
 2) `IcdDxToCustomGrepList`: 選擇`ICD開頭`有符合做為篩選的條件
```{r}
# grepTable
...
```
```
IcdDxToCustomGrepList(icdFile, grepTable)
# "Hypotension"  "Hypotension"  "Hypertension" NA  
```
### 共病症 (Comorbidities)
...
ICD-9-CM (2012): https://www.hcup-us.ahrq.gov/toolssoftware/ccs/Single_Level_CCS_2015.zip

https://www.hcup-us.ahrq.gov/toolssoftware/ccs/Multi_Level_CCS_2015.zip

ICD-10-CM (2018): https://www.hcup-us.ahrq.gov/toolssoftware/ccs10/ccs_dx_icd10cm_2018_1.zip
...
ICD-9-CM (2012-2015): https://www.hcup-us.ahrq.gov/toolssoftware/comorbidity/comorbidity.jsp#references

ICD-10-CM (2018): https://www.hcup-us.ahrq.gov/toolssoftware/comorbidityicd10/comorbidity_icd10.jsp
