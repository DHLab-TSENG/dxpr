...
```
 ...
 1) `IcdDxToCustomGrep`: Use method of exhaustion to find out the matched ICD.
```{r}
# groupingTable 
...
```
 2) `IcdDxToCustomGrepList`: Use a ICD pattern to find out the fit ICD.
```{r}
# grepTable
...
ICD-9-CM (version 1.2, 2015): https://phewascatalog.org/phecodes
