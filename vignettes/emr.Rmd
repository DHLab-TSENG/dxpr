...
```
#### a. `IcdDxToCustom`: Use method of exhaustion to find out the matched ICD.
```{r}
# groupingTable 
...
```
#### b. `IcdDxToCustomGrep`: Use a ICD pattern to find out the fit ICD.
```{r}
# grepTable
