---
title: "Get started with emr: Procedure (Chinese)"
...
head(short$ICD)
```
**warning message** (詳細流程請參考: [診斷前處理與整合方法](https://dhlab-cgu.github.io/emr/articles/Chi_Diagnosis.html#i--code-standardization))
