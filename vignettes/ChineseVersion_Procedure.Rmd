...
```r
## ICD to CCS category
CCS <- IcdPrToCCS(PrDataFile, ID, ICD, Date, "2015-10-01", TRUE)
...
CCSLvl <- IcdPrToCCSLvl(samplePrFile, ID, ICD, Date, "2015-10-01", 2, TRUE)
...
```r
ProcedureClass <- IcdPrToProcedureClass(samplePrFile, ID, ICD, Date, "2015-10-01", TRUE)
