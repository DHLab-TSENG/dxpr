...
#'
groupIcdDxToCustomGrep <- function(icdFile, groupingTable){
  icdFile$ICD <- convertIcdDxDecimaltoShort(icdFile$ICD)$Short
  groupingTable$ICD <- convertIcdDxDecimaltoShort(groupingTable$ICD)$Short
